...
//				outStr.append("@").append(token).append("@"); // metas: c.ghita@metas.ro : 01449
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		if (!newRecord
			&& ("Y".equals(Env.getContextItem(getCtx(), Env.CTXNAME_AcctSchemaElementPrefix + AcctSchemaElementType.LocationFrom.getCode()))
				|| "Y".equals(Env.getContextItem(getCtx(), Env.CTXNAME_AcctSchemaElementPrefix + AcctSchemaElementType.LocationTo.getCode())))
