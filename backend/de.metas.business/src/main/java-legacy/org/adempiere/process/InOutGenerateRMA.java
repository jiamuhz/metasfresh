	...
	private MInOut createShipment(MRMA rma)
	{
		...
		InOutDocumentLocationAdapterFactory
				...
				.setFrom(DocumentLocation.builder()
								 .bpartnerId(BPartnerId.ofRepoId(rma.getC_BPartner_ID()))
								 .bpartnerLocationId(BPartnerLocationId.ofRepoId(rma.getC_BPartner_ID(), originalReceipt.getC_BPartner_Location_ID()))
								 .build());
