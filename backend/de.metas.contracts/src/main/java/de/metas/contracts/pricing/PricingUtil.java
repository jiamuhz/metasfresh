...
public class PricingUtil
{
			...
			@NonNull final SOTrx soTrx)
	{
		return Services.get(IQueryBL.class)
				...
				.addEqualsFilter(I_M_PriceList.COLUMNNAME_M_PricingSystem_ID, pricingSystemId.getRepoId())
				.addEqualsFilter(I_M_PriceList.COLUMNNAME_IsSOPriceList, soTrx.toBoolean())
				.orderBy()
