...
{
	public static ViewRowAttributesLayout of(@NonNull final List<DocumentLayoutUIControlDescriptor> elements)
	{
	...
	private ViewRowAttributesLayout(@NonNull final List<DocumentLayoutUIControlDescriptor> elements)
	{
