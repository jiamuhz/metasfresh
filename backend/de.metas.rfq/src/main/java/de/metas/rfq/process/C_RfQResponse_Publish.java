 ...
 *
 */
public class C_RfQResponse_Publish extends JavaProcess implements IProcessPrecondition
{
	// services
	...
	{
		final I_C_RfQResponse rfqResponse = context.getSelectedModel(I_C_RfQResponse.class);
