...
public class PMMBalanceSegment
{
	...
	public static final PMMBalanceSegment of(final PMMBalanceChangeEvent event)
	{
	...
	private PMMBalanceSegment(final Builder builder)
	{
		super();
	...
	public boolean equals(final Object obj)
	{
		...
		final PMMBalanceSegment other = EqualsBuilder.getOther(this, obj);
		if (other == null)
		{
			return false;
		}
