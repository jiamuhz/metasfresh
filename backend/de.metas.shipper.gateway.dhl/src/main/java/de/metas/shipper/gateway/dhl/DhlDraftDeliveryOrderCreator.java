...
public class DhlDraftDeliveryOrderCreator implements DraftDeliveryOrderCreator
{
	...
	public static final int DHL_MAX_ACCEPTED_GROSS_WEIGHT = 30;
			...
			final CustomDeliveryData customDeliveryData)
	{
		...
		final int grossWeightKgToUse = Math.min(grossWeightKg, DHL_MAX_ACCEPTED_GROSS_WEIGHT); //client wants to pay overweight delivery fee rather than not being able to
